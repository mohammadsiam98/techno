        ...
        <div class="content-header row">
            <div class="content-header-left col-md-12 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <a href="{{route('Contact.restoreList')}}" style="padding: 20px;">
                            ...
                            <table id="html5-extension" class="table table-hover table-bordered non-hover" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">{{$contactDetails->name}}</td>
                                        <td class="text-center">{{$contactDetails->mobilenumber}}</td>
                                        <td>
                                            <a href="{{route('Contact.destroy' , $contactDetails->id)}}">
                                            ...
                                            <a href="{{route('Contact.preview' , $contactDetails->id)}}">
