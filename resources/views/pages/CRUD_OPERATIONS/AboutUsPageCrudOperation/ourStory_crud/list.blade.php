        ...
        <div class="content-header row">
            <div class="content-header-left col-md-12 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        @if($checkthatTheValueExistsOrNot==NULL)
                        <a href="{{route('ourStory.create')}}">
                    ...
                    <div class="card">
                        <div class="widget-content widget-content-area br-6">
                            <table id="html5-extension" class="table table-hover table-bordered non-hover" style="width:100%">
                                ...
                                <tbody>
                                    @foreach ($ourStoryDetails as $key=>$story)
                                    <tr>
                                        <td class="checkbox-column text-center"> {{$key+1}} </td>
                                        <td class="text-center">{!!\Illuminate\Support\Str::limit($story->details, 20)!!}    </td>
                                        <td>
                                            <a href="{{route('ourStory.edit' , $story->id)}}">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2">
                                                    <path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path>
                                                </svg>
                                            </a>
                                            <a href="{{route('ourStory.destroy' , $story->id)}}">
                                            ...
                                            <a href="{{route('ourStory.preview' , $story->id)}}">
