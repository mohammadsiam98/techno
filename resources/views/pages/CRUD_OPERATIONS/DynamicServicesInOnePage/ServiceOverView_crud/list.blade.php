                    ...
                    <div class="card">
                        <div class="widget-content widget-content-area br-6">
                            <table id="html5-extension" class="table table-bordered non-hover" style="width:100%">
                                ...
                                <tbody>
                                    @foreach ($ServiceOverviewDetails as $key=>$details)
                                    <tr>
                                        <td class="checkbox-column text-center"> {{$key+1}} </td>
                                        <td class="text-center badge rounded-pill badge-light-primary me-1">{{$details->get_category->categoryName}}</td>
                                        <td class="text-center">{{$details->page_heading}}</td>
                                        <td class="text-center">{{$details->title}}</td>
                                        <td>
                                            <a href="{{route('ServiceOverviewDetails.edit' , $details->id)}}">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2">
                                                    <path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path>
                                                </svg>
                                            </a>
                                            <a href="{{route('ServiceOverviewDetails.destroy' , $details->id)}}">
                                            ...
                                            <a href="{{route('ServiceOverviewDetails.preview' , $details->id)}}">
