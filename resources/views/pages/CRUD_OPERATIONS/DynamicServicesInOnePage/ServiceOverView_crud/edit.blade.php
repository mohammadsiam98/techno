        ...
        <div class="content-body">
            <section id="basic-horizontal-layouts">
                <div class="row">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{route('ServiceOverviewDetails.update',$ServiceOverviewDetails->id)}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    {{-- Category List --}}
                                        ...
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="category_id" class="select2 form-select" id="select2-basic">
                                                    ...
                                                    <option <?php if($category->id == $ServiceOverviewDetails->category_id){?> selected <?php }  ?> value="{{ $category->id }}">{{ $category->categoryName }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" id="page_heading" class="form-control" name="page_heading" value="{{$ServiceOverviewDetails->page_heading}}" placeholder="Enter the page heading" autocomplete="off" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" id="title" class="form-control" name="title" value="{{$ServiceOverviewDetails->title}}" placeholder="Enter Service Overview Title" autocomplete="off" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea id="my-editor" name="details" class="form-control">{{$ServiceOverviewDetails->details}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
