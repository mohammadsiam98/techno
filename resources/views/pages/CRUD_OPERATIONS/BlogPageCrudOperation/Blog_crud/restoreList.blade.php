...
@section('content')
@section('title', 'Blogs | restoreLists')
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-12 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <a href="{{route('Blogs.create')}}" class="actionButton">
                        ...
                        <a href="{{route('Blogs.list')}}" class="actionButton">
                    ...
                    <div class="card">
                        <div class="widget-content widget-content-area br-6">
                            <table id="html5-extension" class="table table-bordered non-hover" style="width:100%">
                                ...
                                <tbody>
                                    @foreach ($blog_details as $key=>$blog_detailsFetch)
                                    <tr>
                                        <td class="checkbox-column text-center"> {{$key+1}} </td>
                                        <td class="text-center">{{$blog_detailsFetch->title}}</td>

                                        <td>
                                            <a href="{{route('Blogs.edit' , $blog_detailsFetch->id)}}">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2">
                                                    <path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z">
                                                    </path>
                                                </svg>
                                            </a>
                                            <a href="{{route('Blogs.destroy' , $blog_detailsFetch->id)}}">
                                            ...
                                            <a href="{{route('Blogs.forceDelete' , $blog_detailsFetch->id)}}">
